...
public:
    ...
    // Constructor
    DVD();
    DVD(int id, QString  title, QString  author, float duration, int agerestriction);
    DVD(int id, QString  title, QString  author, float duration, int agerestriction, int borrower);
